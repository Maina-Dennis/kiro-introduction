...
- [x] 1. Project scaffold and constants
...
- [ ] 2. Core physics and Kiro object
  - [x] 2.1 Implement Kiro initialization and physics update function
  ...
  - [x] 2.2 Write property test for physics update (Property 1)
...
- [x] 3. Pipe generation and scrolling
  - [x] 3.1 Implement pipe spawning and scroll update
...
- [x] 4. Collision detection
  - [x] 4.1 Implement AABB collision detection and out-of-bounds check
...
- [x] 5. Scoring and high score persistence
  - [x] 5.1 Implement score increment logic and ScoreStore
...
- [x] 7. Cloud parallax system
  - [x] 7.1 Implement cloud initialization and scroll update
...
- [x] 8. Game state machine
  - [x] 8.1 Implement state transitions and input handler
...
- [x] 10. Rendering
  - [x] 10.1 Implement all render functions
...
- [x] 11. Game loop wiring
  - [x] 11.1 Implement the main game loop and wire all components together
